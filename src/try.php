...
try {
    $stmt = $pdo->query("SELECT a.*, e.eventname FROM announcements a JOIN events e ON a.event_id = e.id ORDER BY a.created_at DESC");
    $announcements = $stmt->fetchAll();
} catch (\PDOException $e) {
    exit("Error fetching announcements: " . htmlspecialchars($e->getMessage()));
}
