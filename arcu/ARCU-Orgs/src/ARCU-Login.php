    ...
    try {
        ...
        if ($result->num_rows === 1) {
            ...
            if ($row['acc_pass'] === $acc_pass) {
                ...
                header("Location: ARCU-Dashboard-Student.php"); // Redirect to student dashboard
                exit();
            } else {
...
@import url('https://fonts.googleapis.com/css2?family=Noto+Serif:ital,wght@0,100..900;1,100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900&display=swap');
